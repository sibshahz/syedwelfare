...
const MemberDetails = ({
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            ...
            variant={"outline"}><Pencil size={16} /></Button>
  ...
  <Card className='py-3 mb-4'>
        <CardContent className='flex flex-wrap flex-row gap-2 items-center justify-between py-0'>
        {
          ...
          <Image src={member.media[0].profilePic} width={250} height={300} alt={`${member.name} profile pic`} className='border-8 rounded-sm border-gray' />

        }
        {
          member.media[0].cnicFront && 
          <Image src={member.media[0].cnicFront} width={250} height={300} alt={`${member.name} cnic front`} className='border-8 rounded-sm border-gray' />
        }
        {
          member.media[0].cnicBack && 
          <Image src={member.media[0].cnicBack} width={250} height={300} alt={`${member.name} cnic back`} className='border-8 rounded-sm border-gray' />
        }
        </CardContent>
      </Card>
